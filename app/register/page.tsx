    ...
    <div className="mx-auto max-w-7xl px-6 pb-12 pt-16 text-white text-center lg:px-8">
      ...
      <div className="relative">
        <svg
          ...
          className="absolute -top-10 left-1/2 -z-10 h-[rem] -translate-x-1/2 [mask-image:radial-gradient(closest-side,white,transparent)] sm:-top-12 md:-top-20 lg:-top-12 xl:top-0"
        >
            <ellipse
              cx={604}
              cy={512}

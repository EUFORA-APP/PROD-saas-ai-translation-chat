...
Citizens of EU countries and the United Kingdom must be at least 16 years old to sign up.
    ...
    <p className="text-gray-700 leading-8 mt-4">
    Pro, may be available for purchase in certain countries – offering an even more powerful messaging experience and a chance to support the continuing development of the Telegram platform.
...
Telegram uses third-party payment processors to securely facilitate purchases of Telegram Premium.
    ...
    <p className="text-gray-700 leading-8 mt-4">
    You can cancel Telegram Premium any time. You can cancel your subscriptions by visiting the Subscriptions section.
    </p>
    <h3 className="font-medium text-gray-700 mt-8 text-xl">

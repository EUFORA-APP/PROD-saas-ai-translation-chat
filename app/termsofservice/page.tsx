export default function Home() {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex justify-center items-center mt-8 text-xl">
        <img
          src="/author.jpg"
          alt="ADD IMAGE"
    ...
    By signing up for Eufora, you accept our Privacy Policy and agree not to:

Use our service to send spam or scam users.
Promote violence on publicly viewable Eufora channels, bots, etc.
Post illegal pornographic content on publicly viewable Eufora channels, bots, etc.
...
Citizens of EU countries and the United Kingdom must be at least 16 years old to sign up.
    ...
    <h3 className="font-medium text-gray-700 mt-8 text-xl">
      Terms of Service for EUFORA PRO MEMBERSHIP
    </h3>
    <h3 className="font-medium text-gray-700 mt-8 text-xl">
    Introduction
...
EUFORA uses third-party payment processors to securely facilitate purchases of EUFORA PRO.
    ...
    <p className="text-gray-700 leading-8 mt-4">
    Users in certain regions may be required to pay local taxes, which will be calculated and added to the total cost of a purchase. Payment providers may apply their own commissions and conversion rates to payments in various currencies. This is outside of EUFORA’s control.
    </p>
    <h3 className="font-medium text-gray-700 mt-8 text-xl">
    Cancellation Policy
    </h3>
...
Deleting your EUFORA account or removing the EUFORA application from your device does not cancel your subscription.
    ...
    <h3 className="font-medium text-gray-700 mt-8 text-xl">
    EUFORA can decide to stop offering subscriptions at any time, including in response to unforeseen circumstances beyond our control, or to comply with a legal requirement; in this case we will cancel your subscription and refund the prorated portion of any prepaid subscription fee equal to the remaining unused term of the subscription.
      
    </h3>
    <p className="text-gray-700 leading-8 mt-4">
    You are responsible for all applicable taxes, data plans, internet fees, and other fees associated with your use of EUFORA.

// https://github.com/invertase/stripe-firebase-extensions/blog/107031923116d776ace0d33011a28d29e48fe827/firestore-stripe-payments/functions/src/interface.ts
...
export interface Subscription {
  ...
  /**
   * Array of price references. If you provide multiple recurring prices to the check out session via the `line_items` parameter, 
